...
class AdminAudioFragment : Fragment() {
    ...
    fun getallPosts(
        ...
        try {
            ...
            Log.e("AdminAudioFragment.getAllPosts", e.toString())
        }
    }
    ...
    private fun getallFollowers(owner: LifecycleOwner) {
        try {
            ...
            Log.e("AdminAudioFragment.getAllFollowers", e.toString())
        }
    }
    ...
    fun getallFav(owner: LifecycleOwner) {
        try {
            ...
            Log.e("AdminAudioFragment.getAllFav", e.toString())
        }
    }
