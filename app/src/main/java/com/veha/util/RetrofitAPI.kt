...
//userid and postid
    ...
    fun getVideoPost(@Header("Authorization") dataModal: String?, @Query("page") page: Int, @Query("size") size: Int): Call<JsonObject?>?

    @GET("api/v1/post/admin/audio")
    fun getAudioPost(@Header("Authorization") dataModal: String?, @Query("page") page: Int, @Query("size") size: Int): Call<JsonObject?>?
    ...
    fun updateUser(@Header(value="Authorization") head: String,@Path (value = "userId") userId: String,@Body dataModal: JsonObject?): Call<JsonObject?>?*/
//same as register
